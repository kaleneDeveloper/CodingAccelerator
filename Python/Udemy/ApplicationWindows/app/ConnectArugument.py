...
class App(QtWidgets.QWidget):
    ...
    def setup_UI(self):
        ...
        self.btn_1.clicked.connect(partial(self.clicked_hello, "First button"))
        self.gridLayout.addWidget(self.btn_1, 1, 0, 1, 1)
        
        self.btn_2 = QtWidgets.QPushButton("2")
        self.btn_2.resize(200,200)
        self.btn_2.clicked.connect(partial(self.clicked_hello, "Second button"))
